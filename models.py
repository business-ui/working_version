...
def plot_frames():
    ...
    plt.savefig("/static/images/aggs.png")
    ...
    plt.savefig("/static/images/confirmed.png")
    ...
    ax.legend(loc="lower right")
    plt.savefig("/static/images/dead.png")
    ...
    plt.savefig("/static/images/fatality_rate.png")

    return

@scheduler.task('cron', id='Scheduled_Task', hour=5)
def scheduledTask():
    ...
    with engine.connect() as connection:
        time_slice.to_sql("covid_data", connection, if_exists='append', index=False)
        connection.close()
